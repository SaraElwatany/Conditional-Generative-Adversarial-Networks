...
Training additional InterfaceGAN boundaries for more attributes.

Improving projection speed using encoders such as e4e.

Combining boundary manipulation with text-guided methods such as StyleCLIP.
